...
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            yield mongoose_1.default.connect(`mongodb+srv://${index_1.default.dbUser}:${index_1.default.dbPass}@cluster0.bhwsqpg.mongodb.net/university-management?retryWrites=true&w=majority`);
